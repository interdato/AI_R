...
suppressPackageStartupMessages({
  ...
  library(htmltools)
  library(plotly)   # <- gráficos responsivos para móvil
})
...
tagList(
  ...
  DT::datatable(
    ...
    options = list(
      ...
      scrollX = TRUE,     # scroll horizontal interno
      autoWidth = TRUE
    ),
...
## ⚖️ Calibración (deciles, responsivo)
...
## 📈 Ganancias acumuladas (Lift, responsivo)
